    ...
    return (
        <div className="flex justify-between shadow-2xl mb-5 bg-amber-100 rounded-b-lg">
            ...
            <ul className='flex items-center font-serif text-xl'>
                ...
                <li className={'px-3'}>Discounts</li>
            </ul>
            ...
            <div className={"flex justify-center items-center"}>
                <div style={{position: "relative"}}>
                    ...
                    <Link to={"/cart"}><img src={cart} alt={'cart'} className={"h-12 m-5"}/></Link>
                </div>
                <button className="bg-orange-500 h-12 w-40 my-auto mr-2 rounded-xl ml-3" onClick={logout}>Log out</button>
            </div>
        </div>
    );
}
